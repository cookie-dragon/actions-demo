...
class InternalServer(object):
    ...
    def __init__(self, shelffile=None, parent=None, session_cls=None):
        ...
        # TODO: Change Source Code for Server
...
class InternalSession(object):
    ...
    def write(self, params):
        # TODO: Change Source Code for Server
        if self.user != UserManager.User.Admin and self.iserver.write_listener is not None:
            return self.iserver.write_listener(params, self)
        else:
            # This is Source Code
