...
// TODO: Add by Cooky Long.
static const struct ddr_data ddr3_ok335xd_data = {
    .datardsratio0 = IS43TR16256A125KBLI_RD_DQS,
    .datawdsratio0 = IS43TR16256A125KBLI_WR_DQS,
    .datafwsratio0 = IS43TR16256A125KBLI_PHY_FIFO_WE,
    .datawrsratio0 = IS43TR16256A125KBLI_PHY_WR_DATA,
};

// TODO: Add by Cooky Long.
static const struct cmd_control ddr3_ok335xd_cmd_ctrl_data = {
    .cmd0csratio = IS43TR16256A125KBLI_RATIO,
    .cmd0iclkout = IS43TR16256A125KBLI_INVERT_CLKOUT,

    .cmd1csratio = IS43TR16256A125KBLI_RATIO,
    .cmd1iclkout = IS43TR16256A125KBLI_INVERT_CLKOUT,

    .cmd2csratio = IS43TR16256A125KBLI_RATIO,
    .cmd2iclkout = IS43TR16256A125KBLI_INVERT_CLKOUT,
};

// TODO: Add by Cooky Long.
static struct emif_regs ddr3_ok335xd_emif_reg_data = {
    .sdram_config = IS43TR16256A125KBLI_EMIF_SDCFG,
    .ref_ctrl = IS43TR16256A125KBLI_EMIF_SDREF,
    .sdram_tim1 = IS43TR16256A125KBLI_EMIF_TIM1,
    .sdram_tim2 = IS43TR16256A125KBLI_EMIF_TIM2,
    .sdram_tim3 = IS43TR16256A125KBLI_EMIF_TIM3,
    .zq_config = IS43TR16256A125KBLI_ZQ_CFG,
    .emif_ddr_phy_ctlr_1 = IS43TR16256A125KBLI_EMIF_READ_LATENCY |
                PHY_EN_DYN_PWRDN,
};

// TODO: Add by Cooky Long.
static const struct ddr_data ddr3_htbox_data = {
    .datardsratio0 = IS43TR16640A125JBLI_RD_DQS,
    .datawdsratio0 = IS43TR16640A125JBLI_WR_DQS,
    .datafwsratio0 = IS43TR16640A125JBLI_PHY_FIFO_WE,
    .datawrsratio0 = IS43TR16640A125JBLI_PHY_WR_DATA,
};

// TODO: Add by Cooky Long.
static const struct cmd_control ddr3_htbox_cmd_ctrl_data = {
    .cmd0csratio = IS43TR16640A125JBLI_RATIO,
    .cmd0iclkout = IS43TR16640A125JBLI_INVERT_CLKOUT,

    .cmd1csratio = IS43TR16640A125JBLI_RATIO,
    .cmd1iclkout = IS43TR16640A125JBLI_INVERT_CLKOUT,

    .cmd2csratio = IS43TR16640A125JBLI_RATIO,
    .cmd2iclkout = IS43TR16640A125JBLI_INVERT_CLKOUT,
};

// TODO: Add by Cooky Long.
static struct emif_regs ddr3_htbox_emif_reg_data = {
    .sdram_config = IS43TR16640A125JBLI_EMIF_SDCFG,
    .ref_ctrl = IS43TR16640A125JBLI_EMIF_SDREF,
    .sdram_tim1 = IS43TR16640A125JBLI_EMIF_TIM1,
    .sdram_tim2 = IS43TR16640A125JBLI_EMIF_TIM2,
    .sdram_tim3 = IS43TR16640A125JBLI_EMIF_TIM3,
    .zq_config = IS43TR16640A125JBLI_ZQ_CFG,
    .emif_ddr_phy_ctlr_1 = IS43TR16640A125JBLI_EMIF_READ_LATENCY |
                PHY_EN_DYN_PWRDN,
};
...
// TODO: Edit by Cooky Long.
#if 0
	if (board_is_evm_sk())
#else
    if (board_is_htbox() || board_is_ok335xd())
...
// TODO: Add by Cooky Long.
const struct ctrl_ioregs ioregs_ok335xd = {
    .cm0ioctl       = IS43TR16256A125KBLI_IOCTRL_VALUE,
    .cm1ioctl       = IS43TR16256A125KBLI_IOCTRL_VALUE,
    .cm2ioctl       = IS43TR16256A125KBLI_IOCTRL_VALUE,
    .dt0ioctl       = IS43TR16256A125KBLI_IOCTRL_VALUE,
    .dt1ioctl       = IS43TR16256A125KBLI_IOCTRL_VALUE,
};

// TODO: Add by Cooky Long.
const struct ctrl_ioregs ioregs_htbox = {
    .cm0ioctl		= IS43TR16640A125JBLI_IOCTRL_VALUE,
    .cm1ioctl		= IS43TR16640A125JBLI_IOCTRL_VALUE,
    .cm2ioctl		= IS43TR16640A125JBLI_IOCTRL_VALUE,
    .dt0ioctl		= IS43TR16640A125JBLI_IOCTRL_VALUE,
    .dt1ioctl		= IS43TR16640A125JBLI_IOCTRL_VALUE,
};
...
#else
    if (board_is_htbox())
        config_ddr(400, &ioregs_htbox, &ddr3_htbox_data,
            &ddr3_htbox_cmd_ctrl_data, &ddr3_htbox_emif_reg_data, 0);
    else if (board_is_ok335xd())
    	config_ddr(400, &ioregs_ok335xd, &ddr3_ok335xd_data,
            &ddr3_ok335xd_cmd_ctrl_data, &ddr3_ok335xd_emif_reg_data, 0);
    else if (board_is_evm_sk())
#endif
