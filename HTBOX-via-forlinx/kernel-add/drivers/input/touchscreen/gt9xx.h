...
#include <mach/irqs.h> //for s5pv210
//***************************PART1:ON/OFF define*******************************
...
#define GTP_INT_PORT GPIO_TO_PIN(0,19)
#define GTP_RST_PORT GPIO_TO_PIN(0,20)
#elif defined(CONFIG_OK335XS) || defined(CONFIG_OK335XHTBOX) || defined(CONFIG_OK335XHTBOX4)
#define GTP_INT_PORT GPIO_TO_PIN(1,9)
#define GTP_RST_PORT GPIO_TO_PIN(1,8)
#elif defined(CONFIG_OK335XS2)
#define GTP_INT_PORT GPIO_TO_PIN(2,0)
#define GTP_RST_PORT GPIO_TO_PIN(3,0)
#endif

#define GTP_INT_IRQ     irq_to_gpio(GTP_INT_PORT)
