...
#define GPIO_FT5406_IRQ GPIO_TO_PIN(1,9)
#elif defined(CONFIG_OK335XS2)
#define GPIO_FT5406_IRQ GPIO_TO_PIN(2,0)
#endif
...
static irqreturn_t ft5x0x_ts_interrupt(int irq, void *dev_id)
{
    ...
    disable_irq_nosync(gpio_to_irq(GPIO_FT5406_IRQ));
//    printk("-------------------------INT______-\n");
...
//  ssize_t num_read_chars = 0;
    ...
    disable_irq(gpio_to_irq(GPIO_FT5406_IRQ));
...
static DEVICE_ATTR(ftstpfwver,0666, ft5x0x_tpfwver_show, ft5x0x_tpfwver_store);
//upgrade from *.i
static DEVICE_ATTR(ftsfwupdate, 0666, ft5x0x_fwupdate_show, ft5x0x_fwupdate_store);
static DEVICE_ATTR(ftstprwreg, 0666, ft5x0x_tprwreg_show, ft5x0x_tprwreg_store);
//upgrade from app.bin 
static DEVICE_ATTR(ftsfwupgradeapp, 0666, ft5x0x_fwupgradeapp_show, ft5x0x_fwupgradeapp_store);
...
//  free_irq(client->irq, ft5x0x_ts);
    ...
    i2c_set_clientdata(client, NULL);
        ...
        if(ts_proc_entry!=0)
        {
        remove_proc_entry("driver/ft5x06_ts", NULL);
        }
#endif 
    return 0;
}
