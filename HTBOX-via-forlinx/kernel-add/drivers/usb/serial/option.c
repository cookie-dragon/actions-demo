...
#endif
#if 1 //Added by Xin Yuan
#define XINYUAN_VENDOR_ID                       0x1782
#endif
...
#endif
#if 1 //Added by Xin Yuan
	{ USB_DEVICE_AND_INTERFACE_INFO(XINYUAN_VENDOR_ID, 0x4d10, 0xff, 0, 0) }, /* Eight Serials */
	{ USB_DEVICE_AND_INTERFACE_INFO(XINYUAN_VENDOR_ID, 0x4d11, 0xff, 0, 0) }, /* RNDIS and Eight Serials */
	{ USB_DEVICE_AND_INTERFACE_INFO(XINYUAN_VENDOR_ID, 0x4d12, 0xff, 0, 0) }, /* Optional, NPI Serial */
	{ USB_DEVICE_AND_INTERFACE_INFO(XINYUAN_VENDOR_ID, 0x4d13, 0xff, 0, 0) }, /* ECM and Eight Serials */
#endif
			...
			const struct usb_device_id *id)
{
	...
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C)) {
		if (serial->dev->descriptor.idProduct == cpu_to_le16(0x6002)) {
