...
/* #define CYTTSP5_USE_SPI */
	...
	#elif defined(CONFIG_OK335XS) || defined(CONFIG_OK335XHTBOX) || defined(CONFIG_OK335XHTBOX4)
...
#if defined(CONFIG_OK335XS2) || defined(CONFIG_OK335XHTBOX4)
...
static struct lcd_ctrl_config lcd_cfg = {
		...
		.ac_bias_intrpt		= 0,
		.dma_burst_sz		= 16,
#if defined(CONFIG_OK335XD) || defined(CONFIG_OK335XS2) || defined(CONFIG_OK335XHTBOX4)
		.bpp			= 16,
#else
		.bpp			= 32,
#endif
...
static struct pinmux_config lcdc_pin_mux[] = {
		...
		{"lcd_data15.lcd_data15",	OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT
									 | AM33XX_PULL_DISA},
#if defined(CONFIG_OK335XS) || defined(CONFIG_OK335XHTBOX)
...
{
#if defined(CONFIG_OK335XD) || defined(CONFIG_OK335XHTBOX4)
...
#elif defined(CONFIG_OK335XS) || defined(CONFIG_OK335XHTBOX)
...
//	{"mii1_rxerr.mii1_rxerr", OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLDOWN},
		...
		{"mdio_data.mdio_data", OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
		{"mdio_clk.mdio_clk", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
#elif defined(CONFIG_OK335XHTBOX4)
		// {"mii1_crs.rmii1_crs_dv", OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLDOWN},
		// {"mii1_rxerr.mii1_rxerr", OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLDOWN},
		{"mii1_txen.mii1_txen", OMAP_MUX_MODE1 | AM33XX_PIN_OUTPUT},
		{"mii1_txd1.mii1_txd1", OMAP_MUX_MODE1 | AM33XX_PIN_OUTPUT},
...
#if defined(CONFIG_OK335XHTBOX4)
...
static struct pinmux_config gpio_keys_pin_mux_forlinx[] = {
		...
		{"gpmc_a5.gpio1_21", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},
		{"gpmc_a6.gpio1_22", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},
#elif defined(CONFIG_OK335XHTBOX)
		{"gpmc_csn1.gpio1_30", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // UserKey(gpio1_30 pin56)
		{"gpmc_clk.gpio2_1", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // DI(gpio2_1 pin57)
		{"mcasp0_aclkx.gpio3_14", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // DI_4G(gpio3_14 pin81)
#elif defined(CONFIG_OK335XHTBOX4)
		{"gpmc_a6.gpio1_22", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // UserKey_IN(USER)(gpio1_22 pin128 U15)
		{"gpmc_clk.gpio2_1", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // DI-IO_IN(IN1)(gpio2_1 pin57 V12)
		{"gpmc_ad9.gpio0_23", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  // DI_4GLEDCheck_IN(gpio0_23 pin113 T10)
#endif
		{NULL, 0},
};
...
static struct pinmux_config gpio_led_mux[] = {
		...
		{"usb0_drvvbus.gpio0_18", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},
#elif defined(CONFIG_OK335XHTBOX)
		{"usb0_drvvbus.gpio0_18", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_heartbeat(gpio0_18)
		{"xdma_event_intr0.gpio0_19", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //UserLed(gpio0_19 pin50)
		{"gpmc_csn2.gpio1_31", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_WIFI(gpio1_31 pin35)
		{"gpmc_csn3.gpio2_0", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //DO(gpio2_0 pin55)
		{"mcasp0_fsx.gpio3_15", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_4G(gpio3_15 pin82)
#elif defined(CONFIG_OK335XHTBOX4)
		{"usb0_drvvbus.gpio0_18", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_heartbeat(gpio0_18)
		{"xdma_event_intr0.gpio0_19", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //SW_OUT(WIFI_POW) gpio0_19 50 A15
		{"xdma_event_intr1.gpio0_20", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //SW_OUT(4G_POW) gpio0_20 49 D14
		{"gpmc_csn1.gpio1_30", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //IO_OUT(OUT1) gpio1_30 56 U9
		{"gpmc_ad11.gpio0_27", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_OUT(RC/3) gpio0_27 111 U12
		{"gpmc_ad10.gpio0_26", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_OUT(SIGN/2) gpio0_26 112 T11
		{"gpmc_a1.gpio1_17", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},  //LED_OUT(STAT/1) gpio1_17 121 V14
#endif
		{NULL, 0},
};
...
#if defined(CONFIG_OK335XD) || defined(CONFIG_OK335XS2) || defined(CONFIG_OK335XHTBOX) || defined(CONFIG_OK335XHTBOX4)
...
{
#if defined(CONFIG_OK335XD) || defined(CONFIG_OK335XS) || defined(CONFIG_OK335XS2) 
...
#elif defined(CONFIG_OK335XHTBOX) || defined(CONFIG_OK335XHTBOX4)
	screen_size = SCREEN_SIZE_800X480_7;
#endif
	return 1;
}
...
#elif defined(CONFIG_OK335XHTBOX)
		ret = sprintf(buffer, "OK335xHTBOX");
#elif defined(CONFIG_OK335XHTBOX4)
		ret = sprintf(buffer, "OK335xHTBOX4");
#endif
	}
...
#define prockv_name "kversion"

int prockv_read(char *buffer,char **buffer_location,off_t offset, int buffer_length, int *eof, void *data)
{
	int ret;
	...
	if (offset > 0) {
		...
		/* fill the buffer, return the buffer size */
		ret = sprintf(buffer, "KERNEL_SUBVERSION\nKERNEL_VERSION\nDATE_VERSION\n");
	}

	return ret;
}

int prockv_init(void)
{
	struct proc_dir_entry *Our_Proc_File;

	Our_Proc_File = create_proc_entry(prockv_name, 0644, NULL);

	if (Our_Proc_File == NULL) {
		remove_proc_entry(prockv_name, NULL);
		printk(KERN_ALERT "Error: Could not initialize /proc/%s\n",
				prockv_name);
		return -ENOMEM;
	}

	Our_Proc_File->read_proc = prockv_read;
	//Our_Proc_File->owner = THIS_MODULE;
	Our_Proc_File->mode = S_IFREG | S_IRUGO;
	Our_Proc_File->uid = 0;
	Our_Proc_File->gid = 0;
...
{
#if defined(CONFIG_OK335XD) || defined(CONFIG_OK335XS) || defined(CONFIG_OK335XHTBOX)
